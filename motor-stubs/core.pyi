...
class AgnosticCursor(AgnosticBaseCursor):
    def collation(self: S, *args, **kwargs) -> S: ...
    def add_option(self: S, *args, **kwargs) -> S: ...
    def remove_option(self: S, *args, **kwargs) -> S: ...
    def limit(self: S, *args, **kwargs) -> S: ...
    def skip(self: S, *args, **kwargs) -> S: ...
    def max_scan(self: S, *args, **kwargs) -> S: ...
    def sort(self: S, *args, **kwargs) -> S: ...
    def hint(self: S, *args, **kwargs) -> S: ...
    def where(self: S, *args, **kwargs) -> S: ...
    def max_await_time_ms(self: S, *args, **kwargs) -> S: ...
    def max_time_ms(self: S, *args, **kwargs) -> S: ...
    def min(self: S, *args, **kwargs) -> S: ...
    def max(self: S, *args, **kwargs) -> S: ...
    def comment(self: S, *args, **kwargs) -> S: ...
    def allow_disk_use(self: S, *args, **kwargs) -> S: ...
